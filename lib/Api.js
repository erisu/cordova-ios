...
class Api {
    ...
    prepare (cordovaProject) {
        ...
        return require('../bin/templates/scripts/cordova/lib/prepare').prepare.call(this, cordovaProject);
    }
            ...
            .then(() => {
                if (plugin != null) {
                    ...
                    if (bridgingHeaders.length > 0) {
                        ...
                        const BridgingHeader = require('../bin/templates/scripts/cordova/lib/BridgingHeader').BridgingHeader;
    ...
    addPodSpecs (plugin, podSpecs, frameworkPods, installOptions) {
        ...
        const Podfile = require('../bin/templates/scripts/cordova/lib/Podfile').Podfile;
        const PodsJson = require('../bin/templates/scripts/cordova/lib/PodsJson').PodsJson;
    ...
    build (buildOptions) {
        return check_reqs.run()
            .then(() => require('../bin/templates/scripts/cordova/lib/build').run.call(this, buildOptions));
    }
    ...
    run (runOptions) {
        return check_reqs.run()
            .then(() => require('../bin/templates/scripts/cordova/lib/run').run.call(this, runOptions));
    }
    ...
    clean (cleanOptions) {
        return check_reqs.run()
            .then(() => require('../bin/templates/scripts/cordova/lib/clean').run.call(this, cleanOptions))
            .then(() => require('../bin/templates/scripts/cordova/lib/prepare').clean.call(this, cleanOptions));
    }
